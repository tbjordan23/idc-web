...
import JobBoard, { type JobDTO } from "./JobBoard"
...
// Render this page per-request rather than at build time — the build environment
// (including Railway's build step) isn't guaranteed to have DB access, and job
// listings need to reflect whatever the daily cron sync (railway.cron.toml) last wrote.
...
export default async function IDJobsPage() {
  const jobRecords = await prisma.instructionalDesignJob.findMany({
    orderBy: [{ datePosted: "desc" }, { fetchedAt: "desc" }],
  })

  const jobs: JobDTO[] = jobRecords.map((job) => ({
    id: job.id,
    title: job.title,
    company: job.company,
  ...
  const lastSyncedAt = jobRecords.reduce<Date | null>((latest, job) => {
    if (!latest || job.fetchedAt > latest) return job.fetchedAt
    return latest
  }, null)
  ...
  return (
    <>
      <div className="mx-auto max-w-4xl px-4 pt-16 sm:px-6 lg:px-8">
        <ScrollReveal>
          <p className="mb-3 text-xs font-bold uppercase tracking-widest text-accent">Job Board</p>
          <h1
          ...
          <p className="mt-4 text-lg font-medium text-copy-muted">
            Updated daily from across the web — remote and on-site roles in one place.
          </p>
          {lastSyncedAt && (
            <p className="mt-2 text-xs font-medium text-copy-dim">
              Jobs last synced {timeAgo(lastSyncedAt.toISOString())}
            </p>
          )}
      ...
      >
        <ScrollReveal>
          <p>
            One of the best-kept secrets about instructional design? It opens more doors than most
            people realize. When you can analyze a learning need, design a solution, and build
            something people actually learn from, you become valuable across nearly every industry
            on the planet. From healthcare systems to tech startups to government agencies —
            organizations everywhere need people who know how to make learning work. This guide
            breaks down the job titles you&rsquo;ll encounter, what each role actually does, what
            you can expect to earn, and where the strongest demand is right now.
          </p>
        </ScrollReveal>

        {/* ── Job Titles ─────────────────────────────────────────────────── */}
        <ScrollReveal>
          <h2 className="mt-10 text-heading text-xl font-extrabold tracking-tight">
        ...
        <ScrollReveal delay={1}>
          <p>
            ...
            work described a dozen different ways depending on the organization, the industry, and
            the era. Here are the roles you&rsquo;re most likely to encounter, from entry-level to
            executive.
          </p>
        </ScrollReveal>
        ...
        {/* ── Industries ─────────────────────────────────────────────────── */}
        <ScrollReveal>
          <h2 className="mt-12 text-heading text-xl font-extrabold tracking-tight">
        ...
        <ScrollReveal delay={1}>
          <p>
            Instructional design is a horizontal skill — it crosses every sector where people need
            to learn something. Below are the industries with the most active demand for ID
            professionals, along with what makes each one distinct.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={1}>
          <p>
            The short version: instructional design is growing, and it&rsquo;s not slowing down. The
            U.S. Bureau of Labor Statistics projects steady growth in training and development
        ...
        <ScrollReveal delay={1}>
          <h3 className="mt-6 text-base font-bold text-copy">Remote work normalized the market</h3>
          <p>
            Before 2020, most ID roles were tied to a physical location. Today, remote and hybrid
            positions are the norm — which means you&rsquo;re no longer limited to opportunities in
            your city. A designer in a mid-sized market can compete for tech company roles in San
            Francisco or New York without relocating.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={2}>
          ...
          <p>
            Generative AI is reshaping how IDs work — automating first drafts, accelerating content
            development, and enabling more personalized learning at scale. The designers who are
            thriving right now are using AI to do more strategic work, not less. The ability to
            evaluate, direct, and critically apply AI-generated content is quickly becoming a core
            ID skill.
          </p>
        </ScrollReveal>
        ...
        <ScrollReveal delay={1}>
          ...
          <p>
            ...
            strategic lever for retention, productivity, and organizational agility. That shift is
            creating more senior roles, more CLO positions, and more opportunities for IDs to move
            into leadership without leaving the craft entirely.
          </p>
        </ScrollReveal>
        ...
        <p>
          Compensation in instructional design varies widely based on experience, industry, and
          whether you&rsquo;re in a corporate or education setting. Here&rsquo;s a broad-strokes
          view of what to expect at each career stage.
        </p>
        ...
        <p className="mt-3 text-xs font-bold text-copy-dim">
          ...
          10–25% lower. High-cost metro areas (NYC, SF, Seattle) and tech-sector roles often exceed
          the upper end.
        </p>
        ...
        <ScrollReveal>
          ...
          <p>
            The ID job market is competitive — but it rewards people who show, not just tell. A few
            things that consistently make a difference:
          </p>

          <ul className="list-disc space-y-2.5 pl-5">
            <li>
              <strong className="font-bold text-copy">Your portfolio is your resume.</strong> Hiring
              managers want to see real samples — eLearning modules, design documents, storyboards,
              job aids. A strong portfolio matters more than almost anything else on your
              application.
            </li>
            <li>
              <strong className="font-bold text-copy">Tool fluency signals readiness.</strong>{" "}
              Proficiency in Articulate Storyline, Rise, or a comparable authoring tool is often
              expected at the entry level. LMS experience (Cornerstone, Canvas, Moodle) is a strong
              bonus.
            </li>
            <li>
              <strong className="font-bold text-copy">Frame your experience in outcomes.</strong>{" "}
              Don&rsquo;t just list what you built — describe the impact. &ldquo;Reduced onboarding
              time by 30%&rdquo; or &ldquo;trained 500+ employees across 12 locations&rdquo; is far
              more compelling than &ldquo;created training materials.&rdquo;
            </li>
            <li>
              <strong className="font-bold text-copy">
                Networking opens doors faster than job boards.
              </strong>{" "}
            ...
            <li>
              ...
              ATD&rsquo;s CPTD (Certified Professional in Talent Development) and CPLP are widely
              recognized in corporate L&D. For academic contexts, a master&rsquo;s in instructional
              design, educational technology, or curriculum development carries real weight.
            </li>
          </ul>
        </ScrollReveal>
      </ContentPage>
