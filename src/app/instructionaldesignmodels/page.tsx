    ...
    >
          ...
          {[
            ...
            return (
              <g key={n}>
                ...
                <text x="68" y={y} dominantBaseline="central" fill="var(--text)" fontSize="10.5" fontFamily="sans-serif">{label}</text>
              </g>
            )
          })}
        </svg>
      ...
      <ScrollReveal>
        <div className="mt-12 rounded-card border border-edge bg-surface p-6 shadow-card">
          ...
          >
            Instructional Design Courses &amp; Certificates
          </Link>
          ...
          <div className="mt-4 flex items-start gap-5">
            ...
            <div className="flex flex-col">
              <p className="text-sm font-medium leading-relaxed text-copy-muted">
                You&rsquo;ve been exploring the models that shape how effective learning gets
                designed — from ADDIE and Agile to Merrill&rsquo;s Principles and Gagn&eacute;&rsquo;s
                Events. Ready to put them into practice? IDC&rsquo;s instructional design
                courses walk you through applying these frameworks on real projects, with expert
                instruction and professional certificates upon completion.
              </p>
              <Link
                href="/instructional-design-courses"
        ...
        >
          ...
          {[
            ...
            <g key={label}>
              ...
              <text x={x + 50} y="44" textAnchor="middle" dominantBaseline="central" fill="var(--text)" fontSize="11" fontWeight="700" fontFamily="sans-serif">{label}</text>
            </g>
          ))}
