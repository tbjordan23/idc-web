  ...
  return (
    <>
      ...
      <section className="border-t border-edge bg-surface py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <ScrollReveal>
            <p className="text-xs font-bold uppercase tracking-widest text-accent">Follow IDC</p>
            <h2
              className="mt-2 font-extrabold tracking-tight text-heading"
              style={{ fontSize: "clamp(22px,3vw,34px)", letterSpacing: "-0.05rem" }}
            >
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <ScrollReveal delay={1}>
              <div className="flex h-full flex-col rounded-card border border-edge bg-surface-2 p-6 shadow-card transition-all duration-200 hover:border-edge-hover hover:shadow-card-hover">
                ...
                <h3 className="mt-4 text-base font-extrabold text-heading">LinkedIn</h3>
                <div className="mt-2 h-0.5 w-8 rounded bg-accent opacity-60" />
                ...
                <div className="mt-5 flex flex-col gap-2">
                  <a href="https://www.linkedin.com/company/instructional-design-central" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-accent hover:underline">
                    Follow on LinkedIn
                  ...
                  <a href="https://www.linkedin.com/groups/2672881/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-sm font-semibold text-accent hover:underline">
                    Join LinkedIn Group
                    <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
                  </a>
                </div>
            ...
            <ScrollReveal delay={2}>
              <div className="flex h-full flex-col rounded-card border border-edge bg-surface-2 p-6 shadow-card transition-all duration-200 hover:border-edge-hover hover:shadow-card-hover">
                ...
                <h3 className="mt-4 text-base font-extrabold text-heading">Facebook</h3>
                <div className="mt-2 h-0.5 w-8 rounded bg-accent opacity-60" />
                <p className="mt-3 flex-1 text-sm font-medium leading-relaxed text-copy-muted">
                  Community updates, resources, exclusive offers, and conversations with ID professionals from around the world — all in one place.
                </p>
                <a href="https://www.facebook.com/idcentral" target="_blank" rel="noopener noreferrer" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-accent hover:underline">
                  Follow on Facebook
                  <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
                </a>
              </div>
            ...
            <ScrollReveal delay={3}>
              <div className="flex h-full flex-col rounded-card border border-edge bg-surface-2 p-6 shadow-card transition-all duration-200 hover:border-edge-hover hover:shadow-card-hover">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-[#E1306C]/10">
                ...
                <h3 className="mt-4 text-base font-extrabold text-heading">Instagram</h3>
                <div className="mt-2 h-0.5 w-8 rounded bg-accent opacity-60" />
                <p className="mt-3 flex-1 text-sm font-medium leading-relaxed text-copy-muted">
                  Visual ID inspiration, quick tips, behind-the-scenes looks at IDC, and content designed to brighten your feed and your practice.
                </p>
                <a href="https://www.instagram.com/instructionaldesigncentral/" target="_blank" rel="noopener noreferrer" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-accent hover:underline">
                  Follow on Instagram
                  <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
                </a>
              </div>
            ...
            <ScrollReveal delay={4}>
              <div className="flex h-full flex-col rounded-card border border-edge bg-surface-2 p-6 shadow-card transition-all duration-200 hover:border-edge-hover hover:shadow-card-hover">
                <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-surface">
                  <svg className="h-6 w-6 text-copy" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </div>
                <h3 className="mt-4 text-base font-extrabold text-heading">X (Twitter)</h3>
                <div className="mt-2 h-0.5 w-8 rounded bg-accent opacity-60" />
                <p className="mt-3 flex-1 text-sm font-medium leading-relaxed text-copy-muted">
                  Real-time ID news, quick tips, and conversations with the broader learning and development community — follow along and join the discussion.
                </p>
                <a href="https://twitter.com/id_central" target="_blank" rel="noopener noreferrer" className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-accent hover:underline">
                  Follow on X
                  <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
                </a>
              </div>
