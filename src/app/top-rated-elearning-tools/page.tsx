...
const tools: ElearningTool[] = [
  ...
  },
  {
    rank: 2,
    org: "Articulate",
    name: "Articulate Rise 360",
    image: "/eLearning/Top-eLearning-Tools-Adobe-Articualte-Ris.avif",
    imageAlt: "Articulate Rise 360 logo",
    description:
      "Rise 360 is one of the most elegant rapid-development authoring tools on the market. Entirely web-based, Rise produces courses that are inherently responsive — looking polished and professional on every screen and device without any manual adjustment. Its blocks-based interface makes it fast for both instructional designers and subject-matter experts to contribute content, and AI-assisted drafting accelerates early-stage production. If you're building modern, mobile-first learning and need it done quickly, Rise 360 is hard to beat. It's included with any Articulate 360 subscription.",
    href: "https://articulate.com/360/rise",
    tags: ["Cloud-Based", "Responsive", "Rapid Development", "Part of Articulate 360"],
    highlights: [
      ...
      "Blocks-based building makes course creation fast and collaborative with SMEs",
      "AI-assisted content drafting to accelerate the production workflow",
      "Seamlessly integrates with Review 360 for stakeholder review and sign-off",
    ],
  },
  {
    rank: 3,
