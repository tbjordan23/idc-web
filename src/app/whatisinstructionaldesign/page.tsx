      ...
      <ScrollReveal>
        <div className="mt-12 rounded-card border border-edge bg-surface p-6 shadow-card">
          ...
          <div className="mt-4 flex items-start gap-5">
            ...
            <div className="flex flex-col">
              <p className="text-sm font-medium leading-relaxed text-copy-muted">
                You&rsquo;ve got a solid picture of the field — what instructional design is,
                who does it, and how the work gets done. The next step is building those skills
                yourself. IDC&rsquo;s courses give you practical, expert-led training in the
                frameworks, models, and tools that working instructional designers use every day
                — with certificates to show for it.
              </p>
              <Link
                href="/instructional-design-courses"
