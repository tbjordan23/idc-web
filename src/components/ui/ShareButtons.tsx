...
export default function ShareButtons({ title }: { title: string }) {
  ...
  const btn =
    "flex h-9 w-9 items-center justify-center rounded-full bg-surface-2 text-copy-muted transition-all duration-200"
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      ...
      <button
        ...
        className={`${btn} hover:bg-[#1877F2] hover:text-white`}
      >
      ...
      <button
        ...
        className={`${btn} hover:bg-[#0A66C2] hover:text-white`}
      >
        <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
      ...
      <button
        ...
        className={`${btn} ${igCopied ? "bg-pink-500 text-white" : "hover:bg-pink-500 hover:text-white"}`}
      >
